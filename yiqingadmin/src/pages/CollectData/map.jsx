...
const getGeojsonByCode = (adcode = 520600, withSub = true) => {
    if (!AMapUI) {
...
class MapChart extends React.Component {
    ...
    componentDidMount() {
        getGeojsonByCode(520600, true).then((res) => {
    ...
    render() {
        // const area = [
        //     { key: '10105', name: '江口县', value: 0.1138 },
        //     { key: '10125', name: '德江县', value: 0.0899 },
        ...
        //     },
        // };
        return <Map amapkey={'申请的key'} zoom={6} plugins={['ToolBar']}>
            <Marker position={{ longitude: 109.1953302, latitude: 27.7132676 }} />
        </Map>
    }
}
